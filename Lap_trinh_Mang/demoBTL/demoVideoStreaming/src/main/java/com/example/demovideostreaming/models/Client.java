...
// Java packages
import com.example.demovideostreaming.models.RTCPpacket;
import com.example.demovideostreaming.models.RTPpacket;
...
public class Client{
    ...
    public static void main(String argv[]) throws Exception
    {
        ...
        int serverPort = Integer.parseInt("9080");
        rtpPort = Integer.parseInt("9080");
        mediaFile = "01";
